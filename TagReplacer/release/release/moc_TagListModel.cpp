/****************************************************************************
** Meta object code from reading C++ file 'TagListModel.h'
**
...
#include <memory>
#include "../../TagReplacer/TagListModel.h"
#include <QtCore/qbytearray.h>
#include <QtCore/qmetatype.h>
#if !defined(Q_MOC_OUTPUT_REVISION)
#error "The header file 'TagListModel.h' doesn't include <QObject>."
...
QT_MOC_LITERAL(2, 18, 8) // "TagList*"

    },
    "TagListModel\0list\0TagList*"
};
...
void TagListModel::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::ReadProperty) {
        ...
        void *_v = _a[0];
        switch (_id) {
        case 0: *reinterpret_cast< TagList**>(_v) = _t->list(); break;
        default: break;
        }
        ...
        void *_v = _a[0];
        switch (_id) {
        case 0: _t->setList(*reinterpret_cast< TagList**>(_v)); break;
        default: break;
        }
